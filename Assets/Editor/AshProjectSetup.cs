...
public static class AshProjectSetup
{
    ...
    /// <summary>
    /// PPU(Pixels Per Unit) 16 = 16픽셀 타일 하나가 월드 1유닛.
    ///
    ...
    /// <summary>
    /// 기준 해상도 320x180 기준의 직교 카메라 크기.
    /// 세로 180픽셀 / PPU 16 = 11.25유닛이고, orthographicSize는 그 절반이라 5.625다.
    /// 320x180은 1280x720(4배)과 1920x1080(6배)에 정수배로 떨어져서, 나중에 픽셀 퍼펙트를
    /// 켜도 픽셀이 뭉개지지 않는다.
    ///
